...
skin.button = {
  TileImageBK = ":cl:s44_button_bk.png",
  TileImageFG = ":cl:s44_button_fg.png",
...
skin.line = {
  TileImage = ":cl:s44_line.png",
  tiles = {0, 0, 0, 0},
  TileImageV = ":cl:s44_line_vert.png",
  tilesV = {0, 0, 0, 0},
