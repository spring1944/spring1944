...
function widget:GetInfo()
  return {
    name      = "Night2", --Night2 tweaked to not show lights by default (CarRepairer)
    desc      = versionNumber .. " eeeMakes map appear as nighttime and gives units searchlights.\n"
...
local preUnit              = false                --if true, night is applied pre-unit
local drawBeam             = false                --if true, will draw the searchlight beam
local baseType             = 0               --0: off, 1: simple, 2: full
