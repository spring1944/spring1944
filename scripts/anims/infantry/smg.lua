...
local stances = {
	...
	run_2 =	{
					turns = {
						...
						{rloarm, z_axis, 0},
						{lloarm, x_axis, 0},
						{lloarm, y_axis, math.rad(95)},
						{lloarm, z_axis, math.rad(-65)},
