	...
	while (1)
		{
			...
			turn ruparm to y-axis <20> speed <55>*WALK_SPEED;
			turn luparm to y-axis <-20> speed <55>*WALK_SPEED;
			turn rloarm to x-axis <-110> speed <55>*WALK_SPEED;
			turn lloarm to x-axis <-110> speed <55>*WALK_SPEED;

			//turn ruparm to x-axis <40> speed <20>*WALK_SPEED;
			//turn luparm to x-axis <0> speed <20>*WALK_SPEED;
		...
		if (InAimStance==0 && Fear==0)
		{
			move pelvis to y-axis [1.25] speed <100>*RUN_SPEED;
				...
				if (bMoving==1 && IsProne==0 && fear<=0)
			{
			//turn ruparm to x-axis <0> speed <20>*WALK_SPEED;
			//turn luparm to x-axis <40> speed <20>*WALK_SPEED;
		...
		wait-for-turn rthigh around x-axis;
			...
			wait-for-turn lthigh around x-axis;
			turn ruparm to x-axis <0> speed <100>*RUN_SPEED;
			turn ruparm to y-axis <0> speed <100>*RUN_SPEED;
			turn rloarm to x-axis <0> speed <100>*RUN_SPEED;

			turn luparm to x-axis <0> speed <100>*RUN_SPEED;
			turn luparm to y-axis <0> speed <100>*RUN_SPEED;
